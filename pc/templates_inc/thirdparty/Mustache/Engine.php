...
class Mustache_Engine
{
    ...
    /**
     * Helper method to run a Mustache template class.
     *
     * @param string $source
     *
     ...
     *
     * This is a helper method used by Template instances to run subtemplates for Lambda sections. You can most
    ...
    /**
     * Helper method to run a Mustache Template class cache filename.
     *
     * @param string $source
     *
