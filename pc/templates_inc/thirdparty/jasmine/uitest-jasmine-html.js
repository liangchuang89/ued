...
jasmine.HtmlReporter = function (_doc) {
    ...
    if(window.parent) doc = window.parent.document;
    var reporterView;
    ...
    self.reportRunnerResults = function (runner) {
        //返回JSON结果
        jasmine.JsonReporter(function(result){
            window._ut_json_report = result;
            if(window.parent) window.parent._ut_json_report = result;
